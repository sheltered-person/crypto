...
namespace Elgamal
{
    public class BIGenerator
    {
        ...
        public static BigInteger GeneratePrimeBigInteger(int bitSize, out BigInteger q, out BigInteger k)
        {
            if (bitSize <= 1)
        ...
        {
            return GeneratePrimeBigInteger(bitSize, out BigInteger q, out BigInteger k);
        }
    }
}
